...
import dpbot from "../assets/DPbot.png";
function Header() {
  return (
    <div className="bg-[#EFF3FD] flex justify-between p-2">
      <div className="flex">
        <div className="bg-white rounded-full">
          ...
          <img src={dpbot} alt="dp" className=" h-[50px] rounded-full" />
        </div>
        <div className=" text-[#4C82EF] ">
          <div className="font-poppins font-semibold text-xl flex justify-center items-center gap-1 ">
            Timpu
            <svg
              width="16"
              height="17"
            ...
            >
              ...
              />
              <path
                d="M12.2372 7.84304L9.08468 10.9955L8.45418 10.365"
                fill="#F2CF18"
              />
              <path
      ...
      <div className="flex justify-center items-center">
        ...
        <div className=" text-[#4C82EF] font-poppins font-medium text-base ">
          {" "}
          Online
        </div>
      </div>
